...
export const EXERCISE_VISUALS: ExerciseVisual[] = [
  ...
  entry("renforcement-mollets-pointes", "Renforcement mollets (montées sur pointes)", null, "missing"),
  entry("squats-bulgares", "Squats bulgares", M.FORWARD_LUNGE, "approx"),
  entry("elastique-marche-laterale", "Marche latérale avec élastique", M.LATERAL_SHUFFLE, "approx"),
  entry("souleve-terre-jambe-tendue", "Soulevé de terre jambe tendue", M.FORWARD_HINGE_STRETCH, "approx"),
  entry("gainage-rotation-medecine", "Gainage rotatif (anti-rotation)", null, "missing"),
  entry("tirage-elastique-dos", "Tirage élastique pour le dos", null, "missing"),
  ...
  // PREVENTION
  entry("mobilite-chevilles", "Mobilité chevilles", M.RELAXED_STAND, "generic"),
  ...
  entry("mobilite-hanches-cercles", "Mobilité hanches (cercles)", M.RELAXED_STAND, "generic"),
  ...
  entry("nordic-curl-assiste", "Nordic curl assisté", null, "missing"),
  ...
  entry("mobilite-epaules-cercles", "Mobilité des épaules", M.RELAXED_STAND, "generic"),
